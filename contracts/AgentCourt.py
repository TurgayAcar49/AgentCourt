...
SELLER CLAIM:
{agreement["seller_claim"]}

BUYER DISPUTE:
{agreement["buyer_claim"]}
...
"""
        ...
        def validator_fn(result):
            ...
            try:
                completion = int(data.get("completion_percent", 0))
        ...
        completion = int(result.get("completion_percent", 0))
    ...
    def settle(self, agreement_id: int) -> typing.Any:
        ...
        completion = agreement["completion_percent"]
